...
<div class="ns-page-header" style="display: flex; align-items: center; gap: 15px;">
    ...
    <a href="?page=transactions/invoice/manage" class="ns-btn ns-btn-primary" style="padding: 4px 10px; font-size: 11px; height: 26px; display: inline-flex; align-items: center;"><i class="fas fa-plus"></i> New</a>
</div>
                    ...
                    <td style="text-align: center;">
                        <div style="position: relative; display: inline-block;">
                            ...
                            <div class="ns-action-dropdown-menu">
                                ...
                                <a href="?page=transactions/credit_memo/manage&invoice_id=<?php echo $row['id']; ?>&customer_id=<?php echo $row['customer_id'] ?? ''; ?>" class="ns-action-item">
