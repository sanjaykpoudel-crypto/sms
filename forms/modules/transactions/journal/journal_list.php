                ...
                <?php foreach ($list as $row):
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-weight: 600;">
                            <?php echo number_format($row['total_journal_amount'], 2); ?></td>
                        <td>
                            <span class="badge"
                                style="background: <?php echo $row['status'] == 'posted' ? '#e6fffa' : '#fffaf0'; ?>; color: <?php echo $row['status'] == 'posted' ? '#047481' : '#b7791f'; ?>; border: 1px solid currentColor; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 700; text-transform: uppercase;">
                                <?php echo ucwords($row['status'] ?? 'Draft'); ?>
                            </span>
                        </td>
                        <td style="font-size: 12px;">
                            <?php echo htmlspecialchars($row['creator_name'] ?? $row['created_by']); ?></td>
                        <td style="text-align: center;">
                            <div style="position: relative; display: inline-block;">
                                ...
                                <div class="ns-action-dropdown-menu">
                                    ...
                                    <a href="?page=transactions/journal/manage&id=<?php echo $row['id']; ?>"
