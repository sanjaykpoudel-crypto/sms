                    ...
                    <td style="text-align: center;">
                        <div style="position: relative; display: inline-block;">
                            ...
                            <div class="ns-action-dropdown-menu">
                                ...
                                <a href="?page=transactions/bill/manage&id=<?php echo $row['id']; ?>" class="ns-action-item">
                                    <i class="fas fa-edit" style="color: #0284c7; width: 14px;"></i> Edit
                                </a>
                                <a href="?page=transactions/bill_credit/manage&bill_id=<?php echo $row['id']; ?>&vendor_id=<?php echo $row['vendor_id'] ?? ''; ?>" class="ns-action-item">
