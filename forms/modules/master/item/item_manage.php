        ...
        <div class="ns-form-row">
            <div style="flex: 1;">
                <div class="ns-form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" step="0.01" name="cost_price" class="ns-input" style="padding-left: 35px;"
                            value="<?php echo $data['cost_price'] ?? '0.00'; ?>" required>
                    </div>
                </div>
                <div class="ns-form-group">
                    ...
                    <div style="position: relative;">
                        <span style="position: absolute; left: 10px; top: 10px; color: #999;">Rs</span>
                        <input type="number" step="0.01" name="selling_price" class="ns-input"
                            style="padding-left: 35px;" value="<?php echo $data['selling_price'] ?? '0.00'; ?>"
                            required>
                    </div>
                </div>
                <div class="ns-form-group">
            ...
            <div style="flex: 1;">
                ...
                <div class="ns-form-group">
                    ...
                    <textarea name="description" class="ns-input" rows="4"
