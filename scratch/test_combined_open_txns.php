...
function getOpenTransactions($party_id, $party_type, $payment_id = '') {
    $db = db();
    $results = [];
...
echo "CUSTOMER SANJAY OPEN TRANSACTIONS:\n";
print_r(getOpenTransactions('599abbd6-6f76-4d74-8618-14feed600342', 'customer'));

echo "\nVENDOR FRIENDSHIP OPEN TRANSACTIONS:\n";
print_r(getOpenTransactions('53566186-b9c3-434f-a272-69a46a765c00', 'vendor'));
